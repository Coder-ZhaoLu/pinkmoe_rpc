...
func (cu *CommentUpdate) SetServiceUUID(s string) *CommentUpdate {
	cu.mutation.SetServiceUUID(s)
	return cu
}

// SetUserUUID sets the "user_uuid" field.
func (cu *CommentUpdate) SetUserUUID(s string) *CommentUpdate {
	cu.mutation.SetUserUUID(s)
	return cu
}

// SetType sets the "type" field.
func (cu *CommentUpdate) SetType(u uint32) *CommentUpdate {
...
func (cu *CommentUpdate) SetNillableType(u *uint32) *CommentUpdate {
	if u != nil {
		cu.SetType(*u)
	}
	return cu
...
func (cu *CommentUpdate) AddType(u int32) *CommentUpdate {
...
func (cu *CommentUpdate) sqlSave(ctx context.Context) (n int, err error) {
	...
	if value, ok := cu.mutation.ServiceUUID(); ok {
	...
	if value, ok := cu.mutation.AddedType(); ok {
		_spec.AddField(comment.FieldType, field.TypeUint32, value)
	}
...
// SetServiceUUID sets the "service_uuid" field.
func (cuo *CommentUpdateOne) SetServiceUUID(s string) *CommentUpdateOne {
	cuo.mutation.SetServiceUUID(s)
	return cuo
}

// SetUserUUID sets the "user_uuid" field.
func (cuo *CommentUpdateOne) SetUserUUID(s string) *CommentUpdateOne {
	cuo.mutation.SetUserUUID(s)
	return cuo
}

// SetType sets the "type" field.
func (cuo *CommentUpdateOne) SetType(u uint32) *CommentUpdateOne {
...
// SetNillableType sets the "type" field if the given value is not nil.
func (cuo *CommentUpdateOne) SetNillableType(u *uint32) *CommentUpdateOne {
	if u != nil {
		cuo.SetType(*u)
	}
	return cuo
...
// AddType adds u to the "type" field.
func (cuo *CommentUpdateOne) AddType(u int32) *CommentUpdateOne {
...
func (cuo *CommentUpdateOne) sqlSave(ctx context.Context) (_node *Comment, err error) {
	...
	if value, ok := cuo.mutation.ServiceUUID(); ok {
		_spec.SetField(comment.FieldServiceUUID, field.TypeString, value)
	}
